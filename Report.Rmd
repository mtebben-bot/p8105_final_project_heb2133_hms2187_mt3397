...
For the bottom 5 data frames, the data was sorted so that the lowest score would appear first, while the top 5 score data frames were sorted so the highest scores would appear first. The means and standard deviations are provided as a reference point for the viewer to understand the averages of the four scores and how spread out the data is across the countries.
...
=======
>>>>>>> ff2e8cbbc4f5c5c23b3c12485edaa09b41c5a767
## Additional Analysis
...
In addition to looking at human freedom scores (overall score) and measures of personal and economic freedom – we pulled several sub-indicators of personal and economic freedom that go into this score. Specifically, measures of freedom related to religion, association, assembly, rule of law, homicide, disappearances/conflicts/terrorism, inheritance rights, and size of government. Definitions for these indicators can be found at: [About] (index.html). 
...
Linear regression analysis reveas led a strong relationship between happiness and overall freedom, especially personal freedom. This makes sense, given that human beings have fought for freedom many times over the course of history. As Patrick Henry once said: "Give me liberty, or give me death". It would seem that greater freedom is associated with greater happiness, and (potentially even more so) less freedom is associated with less happiness.

Nordic countries appeared to be particuarly higher on measures of 'personal freedom' to the rest of the world. Considering that Nordic countries are known to implore higher taxes on their citizens to fund the public sector, this would be in line with what we expected to see in this data. Statstical analysis demonstrated that mean citizen happiness in Nordic countries significantly differ from mean citizen happiness in the rest of the world; and that mean human freedom in Nordic countries significantly differs from the rest of the world. 
