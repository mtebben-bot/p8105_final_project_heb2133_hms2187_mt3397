...
Let's start with a scatterplot of happiness (ladder score) by human freedom score.
```{r}
scatter_plot = 
merged_df %>% 
...
## Linear Model 3
The third model will model  happiness with multiple subtypes of freedom: freedom of/from assembly, religion, association, movement, security/safety, inheritance rights, disappearances, conflict, terrorism, rule of law, and homicide.
