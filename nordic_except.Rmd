...
The below table similarly shows data for the happiness and freedom scores within Nordic countries and comparatively to the rest of the world - though now demonstrating scores for other sub categories that contribute to human freedom. 
...
```{r}
nordic_compare %>% 
  subset(countries != "nordic_average") %>% 
